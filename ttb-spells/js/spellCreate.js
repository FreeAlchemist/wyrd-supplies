...
var spellmagia = {
		...
		4 : {
				name:'Волшебство: Телекинез. Перемещение',
		...
		5 : {
				name:'Волшебство: Телекинез. Толчок',
		...
		18 : {
				...
				resist:'Wp',
				range:'5',
				text:'Заклинатель может задать один Да-Нет вопрос живой цели, плюс дополнительный вопрос за каждый Признак успеха (Margin of Success). Персонаж получит правдивый ответ "Да", "Нет", или "Я не знаю" от цели, в меру возможностей цели.',
			},
		19 : {
...
var spellelemental = {
		...
		1 : {
				name:'Тьма',
				TN:'1',
				text:'(Darkness) Персонаж получающий урон от Магии также получает состояние "Ослеплен" на 1 ход.<br>Эта Магия может быть использована несколько раз, увеличивая длительность состояния "Ослеплен" на 1 хож каждый раз.',
			},

		2 : {
				name:'Разложение',
				TN:'1',
				text:'(Decay) Любой Немертвый персонаж получающий урон от Магии вместо этого вылечивает 1 рану.<br>Эта магия может быть использована несколько раз, увеличивая количество лечимого немертвым урона на 1 каждый раз.',
			},
		3 : {
				name:'Электричество',
				TN:'3',
		...
		4 : {
				name:'Огонь',
				TN:'2',
				text:'(Fire)Любой персонаж получающий урон от магии также получает состояние "Горение" +1.<br>Эта магия может быть использована несколько раз, увеличивая значение состояния "Горение" нп 1 каждый раз.',
			},
		5 : {
				name:'Лёд',
				TN:'3',
				text:'(Ice) Любой персонаж получающий урон от магии также получает состояние "Замедлен".<br>Эта магия может быть использована дважды, и во второй раз, цель получает состояние "Паралич" вместо "Замедлен".',
			},
		6 : {
				name:'Природа',
				TN:'2',
		...
		7 : {
				name:'Яд',
				TN:'1',
				text:'(Poison)Любой персонаж получающий урон от магии также получает состояние "Яд" +1.<br>Эта магия может быть использована несколько раз, увеличивая значение состояния "Яд" на 1 каждый раз.',
			},
		8 : {
				name:'Дух',
				TN:'4',
				tnsuit:'',
				text:'(Spirit)Урон наносимый этой магией игнорирует броню и способность "Тяжело ранить" (Hard to Wound).',
			},
		9 : {
				name:'Ужас',
				TN:'1',
				text:'(Terror)Любой персонаж получающий урон от магии должен пройти дуэль Ужаса сложностью TN 6.<br>Эта магия может быть использована несколько раз, увеличивая сложность TN дуэли Ужаса на 1 каждый раз.',
			},
		}
var spellalteration = {
		0 : {},
