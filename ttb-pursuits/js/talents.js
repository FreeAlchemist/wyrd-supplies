...
var talents = {
	general :{
		...
		'Critical strike' : {
				...
				trigger:'<b><span class="symbol ram"/> "Критический удар"</b>: При нанесении урона добавьте 1 дополнительную единицу урона за каждую ♥ в итоговом значении.',
	...
	academic : {
		...
		'Student of Knowledge' : {
				...
				trigger:'<b>♣ "Озарение"</b>: После решения, возьмите карту на руку.',
			},
		'Eureka Moment' : {
				name:'Эврика',
				requirement:'',
				...
				trigger:'<b>♣</b>: Получите 2 дополнительных Margins of Success.',
			},
		'Great Thinker' : {
	...
	criminal : {
		...
		'Competitive Edge' : {
				...
				trigger:'<b>♦ "Подфартило"</b>: После определения результата, вытяните карту.',
				limit:'',
			},
		'Improvise' : {
				name:'Импровизация',
	...
	drudge : {
		...
		'Long Days' : {
				...
				trigger:'<b>♥ "Выздороветь"</b>: После определения результата, вылечить 1 рану.',
				limit:'',
			},
		'Steady Pace' : {
	...
	guard : {
		...
		'Stoic Defender' : {
				...
				trigger:'<b>♦ "По касательной"</b>: Получая урон, уменьшите количество урон на 1, до минимума в 1. ',
				limit:'',
			},
		'Inevitable Defence' : {
	...
	gunfighter : {
		...
		'Quick Draw' : {
				...
				trigger:'<b>♥ "Быстрое выхватывание"</b>: Выполнить действие "Приготовить оружие" незамедлительно после определения результата проверки.',
				limit:'',
			},
		'Call Out' : {
				name:'Вызов',
	...
	mercenary : {
		...
		'Speed Loading' : {
				...
				trigger:'<b>♥</b>: Перезарядить это оружие если его стоимость перезарядки (Reload AP) 2 или ниже.',
				limit:'',
			},
		'Gruesome Attack' : {
				name:'Ужасная атака',
	...
	overseer : {
		...
		'Delegate' : {
				...
				text:'Вы получаете следующий триггер на все дуэли Защиты (Defense):',
				trigger:'<b>♣ “Делегировать”</b>: Когда вам наносят урон, дружественный персонаж в 3 ярдах от вас становиться целью атаки вместо вас.',
				limit:'',
			},
		'You Lazy So & So' : {
				name:'Ты ленивый ...',
	...
	performer : {
		...
		'Powerful Impression' : {
				...
				trigger:'<b>♦ "Впечатлить"</b>: После определения результата, вытяните карту.',
				limit:'',
			},
		'Grace Under Fire' : {
	...
	tinkerer : {
		...
		'Percussive Maintenance' : {
				...
				trigger:'<b>♣ "Преимущество"</b>: Получите 1 дополнительный Признак успеха (Margin of Success).',
				limit:'',
			},
		...
		'Over Pressure' : {
				...
				trigger:'<b>♣</b>: В конце этого хода вы можете выполнить одну дополнительную атаку пневматическим оружием. Дополнительная атака не может заявлять триггеры. Этот триггер может быть активирован только раз в ход.',
				limit:'',
			},
	},
	wastrel : {
